...
public class UserServiceImpl implements UserService{
    ...
    public UserServiceImpl(UserRepository userRepository, JwtUtil jwtUtil, PasswordResetTokenRepository passwordResetTokenRepository, ReminderProducer reminderProducer) {
    ...
    @Override
        public String forgotPassword(String email) {
            ...
            // Publish message to ActiveMQ JMS queue
            reminderProducer.sendPasswordResetRequest(email, token);
